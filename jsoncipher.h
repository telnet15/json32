 ...
 * Comment	: Supporting file for strlen.cpp									*
 ************************************************************************************************************************/
...
#define a 0x70 //0x61 //97 
#define b 0x6c //0x62 //98
#define c 0x76 //0x63 //99
#define d 0x75 //0x64 //100
#define e 0x79 //0x65 //101
#define f 0x64 //0x66 //102
#define g 0x68 //0x67 //103
#define h 0x63 //0x68 //104
#define i 0x66 //0x69 //105
#define j 0x72 //0x6a //106
#define k 0x71 //0x6b //107
#define l 0x78 //0x6c //108
#define m 0x77 //0x6d //109
#define n 0x7a //0x6e //110
#define o 0x74 //0x6f //111
#define p 0x65 //0x70 //112
#define q 0x6c //0x71 //113
#define r 0x61 //0x72 //114
#define s 0x67 //0x73 //115
#define t 0x6a //0x74 //116
#define u 0x6b //0x75 //117
#define v 0x73 //0x76 //118
#define w 0x6f //0x77 //119
#define x 0x69 //0x78 //120
#define y 0x6e //0x79 //121
#define z 0x6d //0x7a //122
